...
def load_CelebA_dataset(train_folder_path, test_folder_path, s=1, n=None, train_list_path=None, test_list_path=None):
    '''
    ...
    train_images = []
    for file_name in tqdm(train_names, desc='Loading train images'):
    ...
    # read and prep test images
    test_images = []
    for file_name in tqdm(test_names, desc='Loading test images'):
