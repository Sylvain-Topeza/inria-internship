...
def main():
    ...
    ### load raw data
    train_set = torch.load(args.data_path + '.pt')
    ...
    if args.debug:
        ...
        ### repeat train images 
        train_set  = repeat_images(train_set,args, N_total=100000) # N_total=250000 for 80x80 or 1000000 for 40x40 in the paper
